...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/bullmdfront)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/bullmdfront
```

A live public deployment of this template is available at [https://bullmdfront.templates.workers.dev](https://bullmdfront.templates.workers.dev)
